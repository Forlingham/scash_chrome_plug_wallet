...
const translations = {
  en: {
    ...
    'common.externalLinkInfo': 'You are about to leave the wallet to visit an external page. Verify the link is trustworthy:',
    'common.save': 'Save',
    'common.edit': 'Edit',
    ...
    'node.status.checking': 'Connecting node...',
    'node.status.disconnected': 'No node available, click to configure',
    'explorer.status.connected': 'Explorer',
    'explorer.status.checking': 'Connecting to explorer...',
    'explorer.status.disconnected': 'Explorer unavailable',

    // 主页新增按钮
    'action.engrave': 'Engrave',

    // DAP / 链上文字
    'dap.myNote': 'My note',
    'dap.transferNote': 'Note to recipient',
    'dap.receivedNote': 'Received note',
    'dap.senderNote': 'Sender note',
    'dap.preview': 'Preview',
    'dap.clickToView': 'Click to view full message',
    'dap.clickToExpand': 'Click to expand',
    'dap.messageContent': 'On-chain message',

    // 发送页补充
    'send.errorSign': 'Failed to sign transaction',
    'send.errorTxid': 'No txid returned by node',
    'send.error': 'Send failed',
    'send.errorInfo': 'Please retry, or check your network and node configuration',
    'send.successScan': 'Scan success',
    'send.successScanDesc': 'Address recognized from QR code',
    'send.errorScan': 'Scan failed',
    'send.errorScanDesc': 'Cannot recognize a valid address from the QR code',
    'send.message': 'Message',
    'send.messagePlaceholder': 'Optional on-chain message (DAP)',
    'send.messageFee': 'Message fee',
    'send.messageNetworkFee': 'Message network fee',
    'send.totalFee': 'Total fee',
    'send.invalidAddress': 'Invalid address format, please check',

    // 刻字 (engrave) 页面
    'send.engraveSuccess': 'Engraved on chain',
    'send.engraveSuccessMsg': 'Your message has been broadcast to the network',
    'send.engraveContent': 'Content',
    'send.engraveLoss': 'On-chain cost',
    'send.engraveNetworkFee': 'Network fee',
    'send.engravePlatformFee': 'Platform fee',
    'send.engraveDesc': 'Permanently store text on the SCASH blockchain via the DAP protocol.',
    'send.engraveText': 'Message',
    'send.engravePlaceholder': 'Type your message here. Markdown is supported.',
    'send.engraveChunkCount': 'Chunks',
    'send.engraveButton': 'Engrave',
    'send.engraveInsufficient': 'Insufficient balance to cover fee + on-chain cost',
    'send.engraveFrom': 'From',

    // QR 扫描器
    'qr.title': 'Scan QR Code',
    'qr.loading': 'Initializing camera...',
    'qr.scanning': 'Scanning...',
    'qr.cameraStopped': 'Camera off',
    'qr.checkPermissions': 'Camera unavailable, please use upload',
    'qr.startScanning': 'Start',
    'qr.stopScanning': 'Stop',
    'qr.upload': 'Upload image',
    'qr.cancel': 'Cancel',
    'qr.error': 'Camera unavailable',
    'qr.errorDesc': 'Failed to start camera: ',
    'qr.retry': 'Retry',

    // 设置主页新条目
    'settings.rpcNodes': 'RPC Nodes',
    'settings.rpcNodesInfo': 'Manage built-in & custom JSON-RPC endpoints',
    'settings.explorer': 'Explorer & Price',
    'settings.explorerInfo': 'Configure block explorer & price source URLs',
    'settings.passwordTooShort': 'New password must be at least 8 characters',

    // Explorer 子页
    'settings.explorer.api': 'Explorer API base URL',
    'settings.explorer.apiInfo': 'Used for address transaction history',
    'settings.explorer.price': 'Coin price URL',
    'settings.explorer.priceInfo': 'Returns JSON containing a USD price field',
    'settings.explorer.web': 'Block explorer site URL',
    'settings.explorer.webInfo': 'Used by the "View on explorer" buttons',

    // RPC 节点子页
    'rpc.add': 'Add RPC Node',
    'rpc.edit': 'Edit RPC Node',
    'rpc.editInfo': 'Configure URL and Basic Auth credentials',
    'rpc.field.name': 'Display name',
    'rpc.field.namePlaceholder': 'My local node',
    'rpc.field.url': 'RPC URL',
    'rpc.field.urlInvalid': 'Invalid URL, please use http:// or https://',
    'rpc.field.user': 'Username',
    'rpc.field.password': 'Password',
    'rpc.testConnection': 'Test connection',
    'rpc.testOk': 'Connection OK',
    'rpc.testFail': 'Connection failed',
    'rpc.permissionDenied': 'Permission denied for this origin',
    'rpc.saved': 'Saved',
    'rpc.added': 'Added',
    'rpc.deleted': 'Deleted',
    'rpc.deleteConfirm': 'Delete this node?',
    'rpc.deleteConfirmInfo': 'This action cannot be undone.',
    'rpc.builtIn': 'Built-in',
    'rpc.setActive': 'Use as active',
    'rpc.failover': 'Auto failover',
    'rpc.failoverInfo': 'Automatically try other enabled nodes when the active one fails',
    'rpc.currentNode': 'Active node',
    'rpc.status': 'Status',
  ...
  zh: {
    ...
    'common.externalLinkInfo': '您即将离开钱包跳转到外部网页，请确认链接安全：',
    'common.save': '保存',
    'common.edit': '编辑',
    'common.delete': '删除',
    'common.reset': '重置',
    ...
    // 节点 / Explorer 信号 UI
    'node.signal.excellent': '极佳',
    'node.signal.good': '良好',
    'node.signal.fair': '一般',
    'node.signal.slow': '较慢',
    'node.signal.disconnected': '断开',
    'node.status.connected': '节点',
    'node.status.checking': '正在连接节点...',
    'node.status.disconnected': '无可用节点，点击去配置',
    'explorer.status.connected': '区块浏览器',
    'explorer.status.checking': '正在连接区块浏览器...',
    'explorer.status.disconnected': '区块浏览器不可用',
    ...
    'dap.senderNote': '对方留言',
    'dap.preview': '预览',
    'dap.clickToView': '点击查看完整内容',
    'dap.clickToExpand': '点击展开',
    'dap.messageContent': '链上消息',

    // 发送页补充
    'send.errorSign': '签名失败',
    'send.errorTxid': '节点未返回 txid',
    'send.error': '发送失败',
    'send.errorInfo': '请重试，或检查网络与节点配置',
    'send.successScan': '识别成功',
    'send.successScanDesc': '已从二维码读取地址',
    'send.errorScan': '识别失败',
    'send.errorScanDesc': '二维码中没有合法地址',
    'send.message': '附言',
    'send.messagePlaceholder': '可选的链上留言（DAP）',
    'send.messageFee': '留言费用',
    'send.messageNetworkFee': '留言网络费',
    'send.totalFee': '总费用',
    'send.invalidAddress': '地址格式错误，请检查输入的地址',

    // 刻字 (engrave) 页面
    'send.engraveSuccess': '上链成功',
    'send.engraveSuccessMsg': '您的留言已广播到网络',
    'send.engraveContent': '内容',
    'send.engraveLoss': '上链消耗',
    'send.engraveNetworkFee': '网络费',
    'send.engravePlatformFee': '平台费',
    'send.engraveDesc': '通过 DAP 协议把文字永久写入 SCASH 区块链。',
    'send.engraveText': '留言内容',
    'send.engravePlaceholder': '请输入留言内容，支持 Markdown',
    'send.engraveChunkCount': '分片数',
    'send.engraveButton': '刻字上链',
    'send.engraveInsufficient': '余额不足以支付费用与上链消耗',
    'send.engraveFrom': '发送方',

    // QR 扫描器
    'qr.title': '扫描二维码',
    'qr.loading': '摄像头初始化中...',
    'qr.scanning': '扫描中...',
    'qr.cameraStopped': '摄像头已关闭',
    'qr.checkPermissions': '摄像头不可用，请使用图片上传',
    'qr.startScanning': '开始扫描',
    'qr.stopScanning': '停止扫描',
    'qr.upload': '上传图片',
    'qr.cancel': '取消',
    'qr.error': '摄像头不可用',
    'qr.errorDesc': '摄像头启动失败：',
    'qr.retry': '重试',

    // 设置主页新条目
    'settings.rpcNodes': 'RPC 节点',
    'settings.rpcNodesInfo': '管理内置与自定义 JSON-RPC 节点',
    'settings.explorer': '区块浏览器 / 币价',
    'settings.explorerInfo': '配置区块浏览器接口与币价数据源',
    'settings.passwordTooShort': '新密码至少 8 位',

    // Explorer 子页
    'settings.explorer.api': '区块浏览器 API',
    'settings.explorer.apiInfo': '用于读取地址历史交易',
    'settings.explorer.price': '币价数据源',
    'settings.explorer.priceInfo': '返回 JSON 中需包含 USD 价格字段',
    'settings.explorer.web': '区块浏览器站点',
    'settings.explorer.webInfo': '用于"在区块浏览器查看"按钮跳转',

    // RPC 节点子页
    'rpc.add': '添加 RPC 节点',
    'rpc.edit': '编辑 RPC 节点',
    'rpc.editInfo': '配置 URL 与 Basic Auth 凭据',
    'rpc.field.name': '名称',
    'rpc.field.namePlaceholder': '我的本地节点',
    'rpc.field.url': 'RPC URL',
    'rpc.field.urlInvalid': 'URL 格式不正确，请用 http:// 或 https://',
    'rpc.field.user': '用户名',
    'rpc.field.password': '密码',
    'rpc.testConnection': '测试连接',
    'rpc.testOk': '连接成功',
    'rpc.testFail': '连接失败',
    'rpc.permissionDenied': '未授权访问该域名',
    'rpc.saved': '已保存',
    'rpc.added': '已添加',
    'rpc.deleted': '已删除',
    'rpc.deleteConfirm': '确认删除该节点？',
    'rpc.deleteConfirmInfo': '该操作无法撤销。',
    'rpc.builtIn': '内置',
    'rpc.setActive': '设为当前',
    'rpc.failover': '自动故障转移',
    'rpc.failoverInfo': '当前节点失败时自动尝试其他启用的节点',
    'rpc.currentNode': '当前节点',
    'rpc.status': '状态',
  ...
  ru: {
    ...
    // ====== Прямое подключение к RPC: новые тексты ======
    'common.continue': 'Продолжить',
    'common.externalLink': 'Внешняя ссылка',
    'common.externalLinkInfo': 'Вы покидаете кошелёк и переходите на внешнюю страницу. Проверьте ссылку:',
    ...
    'node.status.disconnected': 'Узлы недоступны, нажмите для настройки',
    'explorer.status.connected': 'Эксплорер',
    'explorer.status.checking': 'Подключение к эксплореру...',
    'explorer.status.disconnected': 'Эксплорер недоступен',

    'action.engrave': 'Записать на цепочку',

    'dap.myNote': 'Моя заметка',
    'dap.transferNote': 'Заметка получателю',
    'dap.receivedNote': 'Полученная заметка',
    'dap.senderNote': 'Заметка отправителя',
    'dap.preview': 'Просмотр',
    'dap.clickToView': 'Нажмите, чтобы открыть полное сообщение',
    'dap.clickToExpand': 'Нажмите, чтобы развернуть',
    'dap.messageContent': 'Сообщение в цепочке',

    'send.errorSign': 'Не удалось подписать транзакцию',
    'send.errorTxid': 'Узел не вернул txid',
    'send.error': 'Ошибка отправки',
    'send.errorInfo': 'Повторите попытку или проверьте сеть и настройки узла',
    'send.successScan': 'Сканирование успешно',
    'send.successScanDesc': 'Адрес распознан',
    'send.errorScan': 'Ошибка сканирования',
    'send.errorScanDesc': 'В коде нет валидного адреса',
    'send.message': 'Сообщение',
    'send.messagePlaceholder': 'Опциональное сообщение в цепочке (DAP)',
    'send.messageFee': 'Стоимость сообщения',
    'send.messageNetworkFee': 'Сетевая комиссия за сообщение',
    'send.totalFee': 'Итого комиссия',
    'send.invalidAddress': 'Неверный формат адреса',

    'send.engraveSuccess': 'Записано в цепочку',
    'send.engraveSuccessMsg': 'Ваше сообщение отправлено в сеть',
    'send.engraveContent': 'Контент',
    'send.engraveLoss': 'Стоимость записи',
    'send.engraveNetworkFee': 'Сетевая комиссия',
    'send.engravePlatformFee': 'Комиссия платформы',
    'send.engraveDesc': 'Сохраните текст в блокчейне SCASH через протокол DAP.',
    'send.engraveText': 'Сообщение',
    'send.engravePlaceholder': 'Введите ваше сообщение. Поддерживается Markdown.',
    'send.engraveChunkCount': 'Чанков',
    'send.engraveButton': 'Записать на цепочку',
    'send.engraveInsufficient': 'Недостаточно средств для записи',
    'send.engraveFrom': 'От',

    'qr.title': 'Сканировать QR-код',
    'qr.loading': 'Инициализация камеры...',
    'qr.scanning': 'Сканирование...',
    'qr.cameraStopped': 'Камера выключена',
    'qr.checkPermissions': 'Камера недоступна, используйте загрузку файла',
    'qr.startScanning': 'Старт',
    'qr.stopScanning': 'Стоп',
    'qr.upload': 'Загрузить изображение',
    'qr.cancel': 'Отмена',
    'qr.error': 'Камера недоступна',
    'qr.errorDesc': 'Не удалось запустить камеру: ',
    'qr.retry': 'Повторить',

    'settings.rpcNodes': 'RPC-узлы',
    'settings.rpcNodesInfo': 'Управление встроенными и пользовательскими узлами JSON-RPC',
    'settings.explorer': 'Эксплорер и цена',
    'settings.explorerInfo': 'Настройка URL эксплорера и источника цены',
    'settings.passwordTooShort': 'Новый пароль должен быть не менее 8 символов',

    'settings.explorer.api': 'Базовый URL Explorer API',
    'settings.explorer.apiInfo': 'Используется для истории транзакций',
    'settings.explorer.price': 'URL цены',
    'settings.explorer.priceInfo': 'JSON должен содержать поле цены в USD',
    'settings.explorer.web': 'Сайт эксплорера',
    'settings.explorer.webInfo': 'Используется кнопками "Открыть в эксплорере"',

    'rpc.add': 'Добавить RPC-узел',
    'rpc.edit': 'Редактировать RPC-узел',
    'rpc.editInfo': 'Настройте URL и учётные данные Basic Auth',
    'rpc.field.name': 'Имя',
    'rpc.field.namePlaceholder': 'Мой локальный узел',
    'rpc.field.url': 'URL RPC',
    'rpc.field.urlInvalid': 'Неверный URL, используйте http:// или https://',
    'rpc.field.user': 'Имя пользователя',
    'rpc.field.password': 'Пароль',
    'rpc.testConnection': 'Проверить соединение',
    'rpc.testOk': 'Соединение успешно',
    'rpc.testFail': 'Ошибка соединения',
    'rpc.permissionDenied': 'Доступ к этому домену запрещён',
    'rpc.saved': 'Сохранено',
    'rpc.added': 'Добавлено',
    'rpc.deleted': 'Удалено',
    'rpc.deleteConfirm': 'Удалить этот узел?',
    'rpc.deleteConfirmInfo': 'Действие нельзя отменить.',
    'rpc.builtIn': 'Встроенный',
    'rpc.setActive': 'Сделать активным',
    'rpc.failover': 'Авто-переключение',
    'rpc.failoverInfo': 'Автоматически пробовать другие узлы при ошибке',
    'rpc.currentNode': 'Активный узел',
    'rpc.status': 'Статус',
